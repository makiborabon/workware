...
$sql = "SELECT * FROM tbl_product where notes = notes ORDER BY prod_id DESC $limit";
$query = mysqli_query($con, $sql);
...
if(!empty($row["notes"])){
		echo  '<center><h5 height="200">RETURN ITEM</h5></center>'; 
		...
		echo '<center><table class="tbl_records"><tr bgcolor="#D1D1D1" height="40"><th width="50"><small>Update</small></th><th width="50"><small>Delete</small></th><th>Picture</th><th>Product&nbsp;Name</th><th>SKU</th><th>Item Left</th><th>Listed<br>Quantity</th><th>Date Listed</th><th>Notes</th></tr>';
		...
		echo "<td title='$notes'>";
			...
			echo $notes;
					...
					echo'<font color="red">Empty notes</font>';
				}
		echo "</td>";
		/**if($links){
		...
		}else{ echo '<center>No Record Found!</center>';}
