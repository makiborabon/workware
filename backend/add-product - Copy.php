...
/* if file uploader in html form is not empty */
	if(isset($_FILES['file'])) {
		...
		if(!$exist){
				...
				$target = 'products/'.$_FILES['file']['name'];
				
				$prod_name  		 = $_POST['prod_name'];
				$org_quantity 		 = $_POST['org_quantity'];
				$org_quantity2 		 = $_POST['org_quantity2'];
				$SKU 				 = $_POST['SKU'];
				$quality 			 = $_POST['quality'];
				$description	 	 = $_POST['description'];
				$ebay 				 = mysqli_real_escape_string($con,$_POST['ebay']);
				...
				$sql="INSERT INTO tbl_inventory (photo, prod_name, original_quantity, original_quantity2, quality, SKU, description, sizes, colour, style, listed_quantity, links, date)
				VALUE
				('$target', '$prod_name', '$org_quantity','$org_quantity2','$quality', '$SKU', '$description', '$size2', '$colour2', '$style2', '$listed_quantity2', '$ebay', '$date')";
...
<BODY>
	...
	<center>
		<table width=670px" >
			...
			<tr><td><input id="hider" width="100"required type="text" name="org_quantity"  pattern="[0-9.]+" placeholder="Original Quantity"><input id="shower" width="100" required type="text" name="org_quantity2"  pattern="[0-9.]+" placeholder="Confirm Original Quantity"><span  id="out" style="display:none;">  Please make the confirm quantity values</span></td></tr>
			...
			<tr><td><input type="text" name="ebay" placeholder="eBay links    Example: http://www.ebay.co.uk"/></td></tr>
		</table>
