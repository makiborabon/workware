...
/* if file uploader in html form is not empty */
	if(isset($_FILES['file'])) {
		...
		if(!$exist){
				...
				VALUE
				('$files ', '$prod_name', '$quantity', '$org_quantity', '$quality', '$SKU', '$description', '$category', '$sub_category', '$howToUse', '$careInstruct', '$warning', '$size2', '$colour2', '$design2', '$price2', '$listed_quantity2', '$date')";
