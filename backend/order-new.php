...
<html class="no-js" lang="en">
  <head>
	...
	<style>
		...
		.callout{height:450px; overflow-y: scroll;}
			...
			<div class="row">
				...
				<h5>CONFIRMATION AREA</h5>
					 <div class="large-12 medium-12 columns">
						<center> <p><b><h5>NEW ORDER(S)</h5></b> </p></center>
						 <table>
						  <tr style="background:#D1D1D1; position:absolute; top:42px; width:97.1%; left: 14px;"><th width="820">Transactions&nbsp;ID <th>Status</th></tr>
						 </table>
						<div class="callout panel">
						  ...
						  <?php 
							...
							$Query = "SELECT transactions.status, transactions.product_id_array, tbl_product.prod_name, tbl_product.category  FROM transactions
									...
									ON transactions.product_id_array=tbl_product.prod_id  AND transactions.status = '$status' ORDER BY  transactions.product_id_array DESC";
							...
							echo '<table>
									<tr bgcolor="#D1D1D1" >
										...
										<td width="850"><a href="order-detail.php?id='.$prod_name.'">'.$prod_name.'</a></td>
