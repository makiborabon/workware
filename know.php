<?php session_start(); error_reporting(E_ALL);  include('mysqli_connect.php');?>
<!doctype html>
...
<body onload="myFunction()">
    ...
    <div class="row">
	<span class="row" style="background:#C0CEE4; width: 160%; height: 5px; position: absolute; top: -20px; left: -30%;">.</span>
 ...
 function DisplayBanner(){
	...
	else if($tbl_code==113){include('terms-condition.php');}
	else if($tbl_code==114){include('user-account.php');}
